...
<tr>
<td align="left" ><a href="${pageContext.request.contextPath}/department_saveUI.action">添加部门</a></td>
</tr>
...
<td align="right">
   ...
   总记录数:<s:property value="totalCount"/>&nbsp;&nbsp;每页<s:property value="pageSize"/>条记录。
   </span>
